...
VALUES
  ('be3cc829-d8b4-43af-985a-b5a282c88723', 'username1', 'user1@user.ru', 'user11', 'User1 Test', 'UTC', now(), now()),
  ('83d756a8-d819-4ae1-976f-b5feb5b6f378', 'username2', 'user2@user.ru', 'user22', 'User2 Test', 'Europe/Moscow', now(), now());
